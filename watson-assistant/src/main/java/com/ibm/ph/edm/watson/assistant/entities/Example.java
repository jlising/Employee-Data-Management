...
public class Example extends GenericModel {
  ...
  protected List<com.ibm.ph.edm.watson.assistant.entities.Mention> mentions;
  ...
  public static class Builder {
    private String text;
    private List<com.ibm.ph.edm.watson.assistant.entities.Mention> mentions;
     ...
     */
    public Builder addMentions(com.ibm.ph.edm.watson.assistant.entities.Mention mentions) {
      com.ibm.cloud.sdk.core.util.Validator.notNull(mentions, "mentions cannot be null");
      if (this.mentions == null) {
        this.mentions = new ArrayList<com.ibm.ph.edm.watson.assistant.entities.Mention>();
      }
     ...
     * @return the Example builder
     */
    public Builder mentions(List<com.ibm.ph.edm.watson.assistant.entities.Mention> mentions) {
