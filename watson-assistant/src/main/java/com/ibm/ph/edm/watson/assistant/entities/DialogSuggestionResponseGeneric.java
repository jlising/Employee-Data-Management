...
import com.ibm.ph.edm.watson.assistant.entities.DialogNodeOutputOptionsElement;
...
public class DialogSuggestionResponseGeneric extends GenericModel {
  ...
  protected List<com.ibm.ph.edm.watson.assistant.entities.DialogNodeOutputOptionsElement> options;
  ...
  public static class Builder {
    ...
    private List<com.ibm.ph.edm.watson.assistant.entities.DialogNodeOutputOptionsElement> options;
     ...
     */
    public Builder addOptions(com.ibm.ph.edm.watson.assistant.entities.DialogNodeOutputOptionsElement options) {
      com.ibm.cloud.sdk.core.util.Validator.notNull(options, "options cannot be null");
      if (this.options == null) {
        this.options = new ArrayList<com.ibm.ph.edm.watson.assistant.entities.DialogNodeOutputOptionsElement>();
      }
     ...
     * @return the DialogSuggestionResponseGeneric builder
     */
    public Builder options(List<com.ibm.ph.edm.watson.assistant.entities.DialogNodeOutputOptionsElement> options) {
