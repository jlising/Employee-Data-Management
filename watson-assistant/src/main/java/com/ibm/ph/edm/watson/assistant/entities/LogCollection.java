...
import com.ibm.ph.edm.watson.assistant.entities.Log;
import com.ibm.ph.edm.watson.assistant.entities.LogPagination;
...
public class LogCollection extends GenericModel {
  ...
  protected List<com.ibm.ph.edm.watson.assistant.entities.Log> logs;
