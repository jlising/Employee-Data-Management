...
import com.ibm.ph.edm.watson.assistant.entities.MessageContextMetadata;
import com.ibm.ph.edm.watson.assistant.entities.SystemResponse;
...
public class Context extends DynamicModel<Object> {
  ...
  protected com.ibm.ph.edm.watson.assistant.entities.SystemResponse system;

  @SerializedName("metadata")
  protected com.ibm.ph.edm.watson.assistant.entities.MessageContextMetadata metadata;
   ...
   * @return the system
   */
  public com.ibm.ph.edm.watson.assistant.entities.SystemResponse getSystem() {
    return this.system;
  }
   ...
   * @return the metadata
   */
  public com.ibm.ph.edm.watson.assistant.entities.MessageContextMetadata getMetadata() {
