...
import com.ibm.ph.edm.watson.assistant.entities.Mention;
...
public class UpdateExampleOptions extends GenericModel {
  ...
  protected List<com.ibm.ph.edm.watson.assistant.entities.Mention> newMentions;
  ...
  public static class Builder {
    ...
    private List<com.ibm.ph.edm.watson.assistant.entities.Mention> newMentions;
     ...
     */
    public Builder addNewMentions(com.ibm.ph.edm.watson.assistant.entities.Mention newMentions) {
      com.ibm.cloud.sdk.core.util.Validator.notNull(newMentions, "newMentions cannot be null");
      if (this.newMentions == null) {
        this.newMentions = new ArrayList<com.ibm.ph.edm.watson.assistant.entities.Mention>();
      }
     ...
     * @return the UpdateExampleOptions builder
     */
    public Builder newMentions(List<com.ibm.ph.edm.watson.assistant.entities.Mention> newMentions) {
