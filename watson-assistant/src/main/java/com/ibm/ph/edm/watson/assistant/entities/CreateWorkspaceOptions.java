...
import com.ibm.ph.edm.watson.assistant.entities.CreateEntity;
import com.ibm.ph.edm.watson.assistant.entities.CreateIntent;
import com.ibm.ph.edm.watson.assistant.entities.DialogNode;
import com.ibm.ph.edm.watson.assistant.entities.Webhook;
import com.ibm.ph.edm.watson.assistant.entities.WorkspaceSystemSettings;
...
public class CreateWorkspaceOptions extends GenericModel {
  ...
  protected com.ibm.ph.edm.watson.assistant.entities.WorkspaceSystemSettings systemSettings;
  protected List<com.ibm.ph.edm.watson.assistant.entities.CreateIntent> intents;
  protected List<com.ibm.ph.edm.watson.assistant.entities.CreateEntity> entities;
  protected List<DialogNode> dialogNodes;
  protected List<com.ibm.ph.edm.watson.assistant.entities.Counterexample> counterexamples;
  protected List<com.ibm.ph.edm.watson.assistant.entities.Webhook> webhooks;
  ...
  public static class Builder {
    ...
    private com.ibm.ph.edm.watson.assistant.entities.WorkspaceSystemSettings systemSettings;
    private List<com.ibm.ph.edm.watson.assistant.entities.CreateIntent> intents;
    private List<com.ibm.ph.edm.watson.assistant.entities.CreateEntity> entities;
    private List<DialogNode> dialogNodes;
    private List<com.ibm.ph.edm.watson.assistant.entities.Counterexample> counterexamples;
    private List<com.ibm.ph.edm.watson.assistant.entities.Webhook> webhooks;
     ...
     */
    public Builder addIntent(com.ibm.ph.edm.watson.assistant.entities.CreateIntent intent) {
      com.ibm.cloud.sdk.core.util.Validator.notNull(intent, "intent cannot be null");
      if (this.intents == null) {
        this.intents = new ArrayList<com.ibm.ph.edm.watson.assistant.entities.CreateIntent>();
      }
     ...
     * @return the CreateWorkspaceOptions builder
     */
    public Builder addEntity(com.ibm.ph.edm.watson.assistant.entities.CreateEntity entity) {
      com.ibm.cloud.sdk.core.util.Validator.notNull(entity, "entity cannot be null");
      if (this.entities == null) {
        this.entities = new ArrayList<com.ibm.ph.edm.watson.assistant.entities.CreateEntity>();
      }
     ...
     * @return the CreateWorkspaceOptions builder
     */
    public Builder addCounterexample(com.ibm.ph.edm.watson.assistant.entities.Counterexample counterexample) {
      com.ibm.cloud.sdk.core.util.Validator.notNull(
          counterexample, "counterexample cannot be null");
      if (this.counterexamples == null) {
        this.counterexamples = new ArrayList<com.ibm.ph.edm.watson.assistant.entities.Counterexample>();
      }
     ...
     * @return the CreateWorkspaceOptions builder
     */
    public Builder addWebhooks(com.ibm.ph.edm.watson.assistant.entities.Webhook webhooks) {
      com.ibm.cloud.sdk.core.util.Validator.notNull(webhooks, "webhooks cannot be null");
      if (this.webhooks == null) {
        this.webhooks = new ArrayList<com.ibm.ph.edm.watson.assistant.entities.Webhook>();
      }
     ...
     * @return the CreateWorkspaceOptions builder
     */
    public Builder systemSettings(com.ibm.ph.edm.watson.assistant.entities.WorkspaceSystemSettings systemSettings) {
     ...
     * @return the CreateWorkspaceOptions builder
     */
    public Builder intents(List<com.ibm.ph.edm.watson.assistant.entities.CreateIntent> intents) {
     ...
     * @return the CreateWorkspaceOptions builder
     */
    public Builder entities(List<com.ibm.ph.edm.watson.assistant.entities.CreateEntity> entities) {
     ...
     * @return the CreateWorkspaceOptions builder
     */
    public Builder counterexamples(List<com.ibm.ph.edm.watson.assistant.entities.Counterexample> counterexamples) {
     ...
     * @return the CreateWorkspaceOptions builder
     */
    public Builder webhooks(List<com.ibm.ph.edm.watson.assistant.entities.Webhook> webhooks) {
